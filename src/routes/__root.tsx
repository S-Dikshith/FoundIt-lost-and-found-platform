...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Report lost items, post found items, and reconnect belongings with their owners." },
      { property: "og:title", content: "FoundIt — Lost & Found Community Portal" },
      { property: "og:description", content: "Report lost items, post found items, and reconnect belongings with their owners." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FoundIt — Lost & Found Community Portal" },
      { name: "twitter:description", content: "Report lost items, post found items, and reconnect belongings with their owners." },
    ],
    links: [
